...
syscall20:
sw $0, 64($0) #0x0040 = 64 = store x and y values to internal register, x is first 4 bits, y is second 4 bits
lw $v0, 64($0) #0x0040 = 64 = load x and y values into v0 to return
jr $k0
